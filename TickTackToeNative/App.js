...
import { gameText } from "./constant/gameText";
...
const copyArray = (original) => {
  ...
  const copiedArray = original.map((prevInfo) => {
    return prevInfo.slice();
  });
  ...
  return (
    <View style={styles.container}>
      <ImageBackground source={backgroundImage} style={styles.backgroundImage} resizeMode="contain">
        ...
        >
          {gameText.currentTurn}: {currentTurn.toUpperCase()}
        </Text>
        ...
        <View style={styles.buttons}>
          <Text
            ...
            style={[
              styles.button,
              { backgroundColor: gameMode === "LOCAL" ? color.appleColor : color.blackPearl },
            ]}
          >
            {gameText.local}
          </Text>
          <Text
            ...
            style={[
              ...
              {
                backgroundColor:
                  gameMode === "BOT_EASY" ? color.appleColor : color.blackPearl,
              },
            ]}
          >
            {gameText.easyBot}
          ...
          <Text
            ...
            style={[
              ...
              {
                backgroundColor:
                  gameMode === "BOT_MEDIUM" ? color.appleColor : color.blackPearl,
              },
            ]}
          >
            {gameText.mediumBot}
